...
public class FrmRegistrarUsuario extends javax.swing.JFrame {
                        ...
                        .addGroup(jPRegistrarUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPRegistrarUsuarioLayout.createSequentialGroup()
                                ...
                                .addGroup(jPRegistrarUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtFDireccion, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPRegistrarUsuarioLayout.createSequentialGroup()
                                .addGroup(jPRegistrarUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPRegistrarUsuarioLayout.createSequentialGroup()
        ...
        switch (CboxRol.getSelectedItem().toString()) {
            case "Alumno" ->
                fn.ejecutarSentencia("INSERT INTO Alumno (Numero_Control, Nombre_Alumno, Apellido_Alumno, Fecha_Nacimiento, "
                        + "Genero, Telefono, Telefono_Emergencia, Correo, Direccion) VALUES "
                        + "(" + nControl + ", '" + nombre + "', '" + apellido + "', '" + resultado[0] + "', '" + genero + "', '" + telefono
                        + "', '" + telefonoEmergencia + "', '" + correo + "', '" + direccion + "')", false);
            case "Medico" ->
                fn.ejecutarSentencia("INSERT INTO Medico (Numero_Control, Nombre_Medico, Apellido_Medico, Telefono, Telefono_Emergencia, Correo, Direccion) "
                        + "VALUES (" + nControl + ", '" + nombre + "', '" + apellido + "', '" + telefono + "', '" + telefonoEmergencia + "', '" + correo + "', '" + direccion + "')", false);
            case "Secretario" ->
                fn.ejecutarSentencia("INSERT INTO Secretario (Numero_Control, Nombre_Secretario, Apellido_Secretario, Telefono, Telefono_Emergencia, Correo, Direccion) "
                        + "VALUES (" + nControl + ", '" + nombre + "', '" + apellido + "', '" + telefono + "', '" + telefonoEmergencia + "', '" + correo + "', '" + direccion + "')", false);
            default -> {
            }
        }
    ...
    private Boolean comprobarCamposVaciosSegundoPaso(boolean completo) {
        ...
        return nombre.isEmpty() || apellido.isEmpty() || telefono.isEmpty() || telefonoEmergencia.isEmpty() || correo.isEmpty() || direccion.isEmpty();
    }
    ...
    private void desactivarSegundoPaso(boolean completo) {
        ...
        txtFTelefonoEmergencia.setVisible(false);
        ...
        txtFTelefonoEmergencia.setEnabled(false);
    ...
    private void activarSegundoPaso(boolean completo) {
        ...
        txtFTelefonoEmergencia.setVisible(true);
        ...
        txtFTelefonoEmergencia.setEnabled(true);
