...
public class FuncionesValidar {
    ...
    public void validarIDn3(JTextField textField) {
        String regexNumeros = "^[0-9]{0,3}$"; // Permite solo números con un límite de 3 dígitos
        Pattern patronNumeros = Pattern.compile(regexNumeros);
        AbstractDocument document = (AbstractDocument) textField.getDocument();
        ...
        document.setDocumentFilter(new DocumentFilter() {
            ...
            public void replace(DocumentFilter.FilterBypass fb, int offset, int length, String text, AttributeSet attrs)
                ...
                String currentText = fb.getDocument().getText(0, fb.getDocument().getLength());
                currentText += text;
                Matcher matcher = patronNumeros.matcher(currentText);
    ...
    public void validarTexto(JTextField textField) {
        String regexTexto = "^[a-zA-Z0-9 ]+$"; // Permite letras (mayúsculas y minúsculas), números y espacios
        Pattern patronTexto = Pattern.compile(regexTexto);
        AbstractDocument document = (AbstractDocument) textField.getDocument();
        ...
        document.setDocumentFilter(new DocumentFilter() {
            ...
            public void replace(DocumentFilter.FilterBypass fb, int offset, int length, String text, AttributeSet attrs)
                ...
                String currentText = fb.getDocument().getText(0, fb.getDocument().getLength());
                currentText += text;
                Matcher matcher = patronTexto.matcher(currentText);
    ...
    public void validarCodigoPostalRegex(JTextField textField) {
        String regexCodigoPostal = "^[0-9]{0,5}$"; // El código postal debe tener 5 dígitos
        Pattern patronCodigoPostal = Pattern.compile(regexCodigoPostal);
        AbstractDocument document = (AbstractDocument) textField.getDocument();
        ...
        document.setDocumentFilter(new DocumentFilter() {
            ...
            public void replace(DocumentFilter.FilterBypass fb, int offset, int length, String text, AttributeSet attrs)
                ...
                String currentText = fb.getDocument().getText(0, fb.getDocument().getLength());
                currentText += text;
                Matcher matcher = patronCodigoPostal.matcher(currentText);
    ...
    public void validarNumeroDe5Digitos(JTextField textField) {
        String regex = "^[0-9]{0,5}$"; // La expresión regular valida exactamente 5 dígitos
        ...
        document.setDocumentFilter(new DocumentFilter() {
            ...
            public void replace(DocumentFilter.FilterBypass fb, int offset, int length, String text, AttributeSet attrs)
                ...
                if (matcher.matches() || currentText.isEmpty()) {
                    super.replace(fb, offset, length, text, attrs);
                } else {
                    Toolkit.getDefaultToolkit().beep();
                }
