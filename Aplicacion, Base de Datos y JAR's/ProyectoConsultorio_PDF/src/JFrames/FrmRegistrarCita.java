                ...
                .addGroup(jpControlCitasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jpControlCitasLayout.createSequentialGroup()
                        ...
                        .addGroup(jpControlCitasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(dtpFechaHora, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(CboxServicio, 0, 250, Short.MAX_VALUE)
        ...
        if (!camposVacios()) {
            if (fn.verificarExistencia(nControlExiste) == true) {
                if (fe.fechaEsPosterior(dtpFechaHora.getDate(), fe.obtenerFechaActual())) {
                    ...
                    mostrarError("Fecha no Valida", "Verifica que la fecha sea posterior a la actual");
                }
            } else {
