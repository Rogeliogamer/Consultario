...
public class FrmRegistrarUsuario extends javax.swing.JFrame {
    ...
    public FrmRegistrarUsuario() {
        ...
        TextPrompt pHNumeroInterior = new TextPrompt("Núm. Interior", txtFNumeroInterior);
        TextPrompt pHNumeroExterior = new TextPrompt("Núm. Exterior (Opcional)", txtFNumeroExterior);
