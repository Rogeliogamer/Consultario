...
public class FrmRegistrarCita extends javax.swing.JFrame {
    ...
    private void modificarCita() {
        ...
        if (filaSeleccionada != -1) {
            ...
            String modificarCitaSQL = "UPDATE Cita SET "
                    ...
                    + "Id_Consultorio = (" + idConsultorioSQL + "), Id_Servicio = (" + idServicio + "), "
                    + "Fecha = '" + resultado[0] + "', Hora = '" + resultado[1] + "' WHERE Id_Cita = " + id;
    ...
    private Boolean conflictoCita() {
        ...
        if (adelante && !atras) { // Entramos en conflicto con una cita posterior (nuestra cita no cumpliria su rango de tiempo)
            ...
            System.out.println("Cita de adelante: " + idCitaConflictiva);
            ...
            System.out.println("Cita de atras: " + idCitaConflictiva);
            ...
            System.out.println("Cita atras: " + idCitaConflictivaAtras + " y " + "Cita adelante: " + idCitaConflictivaAdelante);
