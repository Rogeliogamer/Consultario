...
public class FuncionesPDF {
 ...
 /* Datos Medico: 
        ...
        try {
            ...
            String direccionAlumno = "Calle: " + datosPaciente[10] + ", Número Interior: " + datosPaciente[11] + ", Municipio: " + datosPaciente[7] + ", Estado: " + datosPaciente[8] + ", C.P. " + datosPaciente[9];
            ...
            documento.add(new Paragraph(direccionAlumno, FontFactory.getFont(FontFactory.HELVETICA, 12)));
            ...
            String direccionMedico = "Calle " + datosMedico[8] + ", Número Interior: " + datosMedico[9] + ", Municipio: " + datosMedico[5] + ", Estado: " + datosMedico[6] + ", C.P. " + datosMedico[7];
            ...
            documento.add(new Paragraph(direccionMedico, FontFactory.getFont(FontFactory.HELVETICA, 12)));
    ...
    public void generarFichaClinica(String[] datosFichaClinica, String rutaArchivo) {
        ...
        try {
            ...
            if (datosFichaClinica[10].equals("null")) {
                datosFichaClinica[10] = "No hay una última cita asociada a este alumno";
            }
