...
public class FrmRegistrarCita1 extends javax.swing.JFrame {
    ...
    public FrmRegistrarCita1(String idCitaSeleccionada, String alumnoSeleccionado, String medicoSeleccionado, String servicioSeleccionado, Date fechaCitaSeleccionada) {
        initComponents();
    ...
    private Boolean conflictoCita() {
        ...
        if (adelante && atras) {
            if ((idCitaConflictivaAtras.equals(idCitaConflictivaAdelante) && idCitaSeleccionada.equals(idCitaConflictivaAtras))) {
                ...
                mostrarError("Conflicto de Citas", "El Dr. está ocupado exactamente a esta hora");
                return true;
            }
        } else if (atras && !adelante) {
            datos = obtenerDatosConflicto(idCitaConflictivaAtras);
            mostrarError("Conflicto de Citas: El Dr. ", datos[0] + " está ocupado a las " + datos[1]);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRegistrarCita1().setVisible(true);
            }
        });
    }
